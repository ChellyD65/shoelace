...
Now execute the FASTQ_dumper.py script located in <installdir>/python/shoelace/scripts/.  You can include the path to your config file as a command line argument:
